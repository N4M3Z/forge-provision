...
- **The export keeps its passphrase** — a stolen printout alone is not game-over. The passphrase is stored separately from the key material: split knowledge without Shamir's quorum fragility.
